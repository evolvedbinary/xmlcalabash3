...
val releaseArtifact = "polyglot"
val releaseDescription = "Polyglot steps for XML Calabash 3.x"
    ...
    maven {
      mavenCentral {
        register("release-deploy") {
          ...
          stagingRepositories.add("../../ext/polyglot/build/maven-release")
        }
      }
      nexus2 {
        register("snapshot") {
...
tasks.register("helloWorld") {
  doLast {
    println("Publishing XML Calabash Polyglot...")
  }
}
