...
val releaseArtifact = "basex"
val releaseDescription = "BaseX steps for XML Calabash 3.x"
    ...
    maven {
      mavenCentral {
        register("release-deploy") {
          ...
          stagingRepositories.add("../../ext/basex/build/maven-release")
        }
      }
      nexus2 {
        register("snapshot") {
...
tasks.register("helloWorld") {
  doLast {
    println("Publishing XML Calabash BaseX...")
  }
}
