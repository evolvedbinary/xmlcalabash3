...
object ExternalDependencies {
    val steps = mapOf<String,List<String>>(
        ...
        "diagramming" to listOf("net.sourceforge.plantuml:plantuml:1.2025.2", // plantuml includes ditaa
        ...
        "metadata-extractor" to listOf("com.drewnoakes:metadata-extractor:2.19.0",
            "org.apache.pdfbox:pdfbox:2.0.32", // pdfbox dep for parsing XML in pdfbox
