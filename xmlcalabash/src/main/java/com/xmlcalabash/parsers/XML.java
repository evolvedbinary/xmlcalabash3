...
// This file was generated on Thu Aug 28, 2025 17:58 (UTC+01) by REx v6.2-SNAPSHOT which is Copyright (c) 1979-2025 by Gunther Rademacher <grd@gmx.net>
// REx command line: -faster -java -tree XML.ebnf
...
public class XML
{
    ...
    public XML(CharSequence string, EventHandler t)
    {
        initialize(string, t);
    }
    ...
    private static String[] getTokenSet(int tokenSetId)
    {
        ...
        for (int i = 0; i < 67; i += 32)
        {
            ...
            int i0 = (i >> 5) * 280 + s - 1;
            int i1 = i0 >> 2;
            int f = EXPECTED[(i0 & 3) + EXPECTED[(i1 & 63) + EXPECTED[i1 >> 6]]];
            for ( ; f != 0; f >>>= 1, ++j)
            {
                if ((f & 1) != 0)
                {
    ...
    private static final int[] EXPECTED =
            {
                    ...
                    /* 229 */ 0, 0, 134217728, -2147483648, 0, 0, 0, 2, 0, 0, 0, 4, 4, 4194312, 33554440, 8, 64, 64, 128, 256, 256,
                    /* 250 */ 8192, 128, 16908288, 1140850688, 67108864, 1140850692, 67108868, 134217732, -2147483644, 4, 34603016,
                    /* 261 */ -2147483640, 32, 32, 32, 32, 0, 1024, 2048, 262144, 524288, 33554432, 201326592, 1140850688, 0, 0, 0,
                    ...
                    /* 349 */ 134218752, 4096, 0, 4096, 4096, -2147479552, 100663296, 1073741824, 0, 0, 512, 1024, 4096, 2097152,
                    /* 363 */ 536870912, -2147483648, 0, 0, 8, 0, 4, 134218752, 0, 1024, 100663296, 40960, 0, 0, -1610608640, 10, 3072,
