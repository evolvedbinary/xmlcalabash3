...
class StandardDocumentResolver: DocumentResolverProvider, DocumentResolver {
    private val uriMapping = mapOf(
        ...
        URI("https://xmlcalabash.com/ext/library/pdf-steps.xpl") to "/com/xmlcalabash/ext/pdf-steps.xpl",
        ...
        URI("https://xmlcalabash.com/ext/library/tesseract.xpl") to "/com/xmlcalabash/ext/tesseract.xpl",
