...
object Ns {
    ...
    val allowDuplicateNames = QName("allow-duplicate-names")
    ...
    val doctypePublic = QName("doctype-public")
    val doctypeSystem = QName("doctype-system")
    ...
    val escapeUriAttributes = QName("escape-uri-attributes")
    ...
    val id = QName("id")
    val includeContentType = QName("include-content-type")
    ...
    val itemSeparator = QName("item-separator")
    val jar = QName("jar")
    val json = QName("json")
    val jsonNodeOutputMethod = QName("json-node-output-method")
    val key = QName("key")
    ...
    val requestTimeout = QName("request-timeout")
    val required = QName("required")
    val responseTimeout = QName("response-timeout")
    ...
    val standalone = QName("standalone")
    ...
    val suppressIndentation = QName("suppress-indentation")
    val systemIdentifier = QName("system-identifier")
    val tar = QName("tar")
    val target = QName("target")
    val templateName = QName("template-name")
    val templateParameters = QName("template-parameters")
    val templateTunnelParameters = QName("template-tunnel-parameters")
    ...
    val type = QName("type")
    val undeclarePrefixes = QName("undeclare-prefixes")
    val username = QName("username")
    val useWhen = QName("use-when")
    val useCharacterMaps = QName("use-character-maps")
    ...
    val validationMode = QName("validation-mode")
