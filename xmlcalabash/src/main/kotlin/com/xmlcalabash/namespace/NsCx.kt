...
object NsCx {
    ...
    val host = QName(namespace, "cx:host")
    ...
    val lineNumbering = QName(namespace, "cx:line-numbering")
    ...
    val metadata = QName(namespace, "cx:metadata")
    ...
    val password = QName(namespace, "cx:password")
    val pipeline = QName(namespace, "cx:pipeline")
    val port = QName(namespace, "cx:port")
    val processor = QName(namespace, "cx:processor")
    val properties = QName(namespace, "cx:properties")
    ...
    val username = QName(namespace, "cx:username")
    ...
    val cacheStylesheet = QName(namespace, "cx:cache-stylesheet")
    val cacheGrammar = QName(namespace, "cx:cache-grammar")
    val cacheQuery = QName(namespace, "cx:cache-query")
    val cacheExpression = QName(namespace, "cx:cache-expression")
    ...
    val manifest = QName(namespace, "cx:manifest")
    val multiplex = QName(namespace, "cx:multiplex")
    ...
    val output = QName(namespace, "cx:output")
    val part = QName(namespace, "cx:part")

    val pdfbox = QName(namespace, "cx:pdfbox")
    val pdfInfo = QName(namespace, "cx:pdf-info")
    val pdfExtract = QName(namespace, "cx:pdf-extract")
    val pdfMerge = QName(namespace, "cx:pdf-merge")
    val pdfCopy = QName(namespace, "cx:pdf-copy")
    val pdfForm = QName(namespace, "cx:pdf-form")
    val pdfDecrypt = QName(namespace, "cx:pdf-decrypt")
    val pdfEncrypt = QName(namespace, "cx:pdf-encrypt")
    val pdfToImages = QName(namespace, "cx:pdf-to-images")
    ...
    val tesseract = QName(namespace, "cx:tesseract")
