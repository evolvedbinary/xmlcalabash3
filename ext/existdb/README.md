...
`com.xmlcalabash:existdb:<version>` to your project.
...
You can configure XML Calabash so that it will use eXist-db as the default
implementation of the `p:xquery` step. See the configuration chapter of the user
